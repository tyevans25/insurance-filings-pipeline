...
Available Tools:
1. semantic_search(query, limit, company) - Search narrative text from filings with actuarial synonym expansion
...
Acknowledge any limitations in the available data and suggest what additional information would be helpful."""
    ...
    def answer_query(self, query: str, company: str = None) -> Dict:
        ...
        # VARIANT 2: Use semantic_search for ALL queries (with query expansion)
